...
export const EXTENSIONS_DATA: Extension[] = [
  ...
  { id: 5, emoji: "🐳", color: "#0ea5e9", name: "Docker Manager",       desc: "Gerencie containers sem abrir o terminal",    enabled: false, official: false },
  { id: 6, emoji: "🌦️", color: "#60a5fa", name: "Weather",             desc: "Previsão do tempo com localização automática",enabled: true,  official: false },
  { id: 7, emoji: "📦", color: "#ef4444", name: "NPM Scripts",          desc: "Execute scripts do package.json diretamente", enabled: false, official: false },
  { id: 8, emoji: "🔢", color: "#10b981", name: "JSON Formatter",       desc: "Formate e valide JSON instantaneamente",      enabled: true,  official: false },
];
